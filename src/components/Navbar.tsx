...
const Navbar = () => {
  return (
    <div className="fixed top-0 left-0 right-0 z-10">
      <div className="container mx-auto pt-3 bg-gradient-to-b from-white to-white/0 bg-opacity-100"> {/* Added bg-gradient-to-b and bg-opacity-90 classes */}
        <div className="flex justify-center items-center">
          <nav className="flex justify-between items-center w-full">
              ...
              <Link href="/">
                <div className="text-xl text-green-700 flex items-center">
                  ...
                  <div className="ml-5 flex flex-nowrap">
                    <p className="mr-2">A&nbsp;Fuel</p>
                    <p className="font-bold mr-2">Analysis</p>
                    <p>Tool</p>
                  </div>
                </div>
              </Link>
            ...
            <div className="flex space-x-4 items-center">
              <Link className="text-md flex items-center rounded-md px-4 py-1 bg-blue-900 hover:bg-blue-800 text-white" href="/login">
                <span className="mx-auto">Log In</span>
              </Link>
              <Link className="text-md flex items-center rounded-md hover:shadow-none px-4 py-1 bg-green-700 hover:bg-green-600 text-white" href="/signup">
